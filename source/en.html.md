...
## Construct the structure of transfer transactions
...
## Signature
<aside class="warning">It is strongly not recommended that developers use this interface in a production environment</aside>
...
| --- | ------|-------------|
| chainId | Y | chain Id |
| gasAssetId | Y | gas asset ID |
| gasPrice | Y | gas price |
...
256 | Create Account
257 | Update account
259 | Update account weight
512 | Issue additional assets
513 | Issue assets 
514 | Destroy assets
515 | Transfer
516 | Update Asset Agreement

### accountType parameter
Name | Remark
---|---
1 | System root account
2 | System sub account
3 | Community root account
4 | Community sub-account
5 | Personal account
6 | Special account
